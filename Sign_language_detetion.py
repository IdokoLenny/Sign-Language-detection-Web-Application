...
if app_mode =='Select Mode':
    ...
    st.markdown('''
              # About Us \n 
               HealthPRO is at the forefront of revolutionizing communication in healthcare for 
               individuals with hearing and speech disabilities. Our cutting-edge AI HealthTech 
               solutions empower medical practitioners to effectively interpret sign languages, 
               ensuring seamless and inclusive interactions with patients. Committed to bridging 
